            ...
            <View style={{
                ...
                <View style={{
                    ...
                    <Text style={{ fontSize: 25 }}>
                            {props.state.ViajeReducer.data.movimientos["negociacion_conductor"].monto}
                        </Text>
                ...
                <View style={{
                    ...
                    <Text>
                        Precione cobrar una ves el cliente aya saldado la deuda.
                        </Text>
                </View>
...
export default connect(initStates)(CobrarViaje);
