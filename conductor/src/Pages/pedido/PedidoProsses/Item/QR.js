...
import { SImage, SLoad, SStorage } from 'servisofts-component';
...
const PEDIDOS_IN_MEMORY = {}
export default class QR extends Component {
    constructor(props) {
        super(props);
        this.state = {
            data: PEDIDOS_IN_MEMORY[this.props.data.key]
        }
    }
    componentDidMount() {
        this.getQr();

        // SStorage.getItem("qr_pedido_" + this.props.data.key, (resp) => {
        //     this.qr;
        //     if (!resp) {
        //         return;
        //     }
    ...
    getQr() {
        ...
        SSocket.sendPromise({
            ...
            PEDIDOS_IN_MEMORY[this.props.data.key] = resp.data;
            // SStorage.setItem("qr_pedido_" + this.props.data.key, JSON.stringify(resp.data));
